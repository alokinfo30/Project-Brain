...
class ModelManager:
    ...
    def __init__(self):
        ...
        self.app_name = os.getenv('OPENROUTER_APP_NAME', 'ProjectPlanner')
        ...
        self.agent_models = {
            'project_planning_agent': os.getenv('PROJECT_PLANNING_MODEL', self.primary_model),
            'estimation_agent': os.getenv('ESTIMATION_MODEL', self.primary_model),
            'resource_allocation_agent': os.getenv('RESOURCE_ALLOCATION_MODEL', self.primary_model)
        }
    ...
    def _get_agent_temperature(self, agent_type: str) -> float:
        ...
        temperatures = {
            'project_planning_agent': 0.3,
            'estimation_agent': 0.2,
            'resource_allocation_agent': 0.4
        }
